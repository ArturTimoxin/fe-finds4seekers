...
const Footer = ({ userData, toggleAuthModal, setAuthModalMode }) => {
    ...
    <footer className="footer">
      ...
      <div className="footer-links">
        <div className="wrap-text-links">
          ...
          {!userData ? (
            <>
              <a onClick={onClickLoginLink} className="footer-link">
                Login
              </a>
              <a onClick={onClickSignUpLink} className="footer-link">
                Sign Up
              </a>
            </>
          ) : (
        ...
        <div className="contact-links">
          ...
          <div className="company-info">
            ...
            <div className="company-subinfo">
              {new Date().getFullYear()} TheFinds4Seekers, Inc. All rights
              reserved.
            </div>
          </div>
        </div>
