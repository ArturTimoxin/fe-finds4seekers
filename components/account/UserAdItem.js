...
import DefaultPhoto from "../../p/default-photo.png";
  ...
  return (
    <Item className="user-ad-list-item">
      <Link href={`/ad?adId=${id}`}>
        <img className="user-ad-item-img" src={photo ? photo : DefaultPhoto} />
      </Link>
      <div className="wrap-user-ad-item-list">
        <div className="user-ad-info-wrap">
          <Link href={`/ad?adId=${id}`}>
            <Item.Header className="title-ad-item-list">
        ...
        <div className="user-ad-subcolumn">
          <div className="list-actions-wrap">
            <Link href={`/account/edit?id=${id}`}>
              <Button className="list-action" color="blue">
                Edit
              </Button>
            </Link>
            <Button
          ...
          <Item.Extra className="actual-to-text">
